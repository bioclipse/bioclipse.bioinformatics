...
public class WsParameterDetails  implements java.io.Serializable {
    ...
    private uk.ac.ebi.jdispatcher.soap.WsParameterValue[] values;
    ...
    public WsParameterDetails(
           ...
           uk.ac.ebi.jdispatcher.soap.WsParameterValue[] values) {
           this.name = name;
     ...
     */
    public uk.ac.ebi.jdispatcher.soap.WsParameterValue[] getValues() {
        return values;
    }
     ...
     */
    public void setValues(uk.ac.ebi.jdispatcher.soap.WsParameterValue[] values) {
        this.values = values;
    }
