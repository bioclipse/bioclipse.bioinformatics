...
public class WsParameterValue  implements java.io.Serializable {
     ...
     * value */
    private uk.ac.ebi.jdispatcher.soap.WsProperty[] properties;
    ...
    public WsParameterValue(
           ...
           uk.ac.ebi.jdispatcher.soap.WsProperty[] properties) {
           this.label = label;
           this.value = value;
     ...
     * value
     */
    public uk.ac.ebi.jdispatcher.soap.WsProperty[] getProperties() {
        return properties;
    }
     ...
     * value
     */
    public void setProperties(uk.ac.ebi.jdispatcher.soap.WsProperty[] properties) {
        this.properties = properties;
    }
